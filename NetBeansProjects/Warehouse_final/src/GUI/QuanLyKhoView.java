...
public class QuanLyKhoView extends JFrame {
    ...
    public void initComponents(){
        ...
        lbID = new JLabel("Mã NV: ");
        dataID = new JLabel();
        
        lbLoai = new JLabel("Vị trí: ");
        dataLoai = new JLabel();
        ...
        ImageIcon iconNhaCungCap = new ImageIcon("./src/Images/office-building.png");
        ...
        JLabel lbNhaCungCap = new JLabel("NHÀ CUNG CẤP", JLabel.CENTER);
        ...
        ImageIcon iconThongKe = new ImageIcon("./src/Images/analytics.png");
        ...
        JLabel lbThongKe = new JLabel("THỐNG KÊ", JLabel.CENTER);
        ...
        ImageIcon iconNhanVien = new ImageIcon("./src/Images/employees.png");
        ...
        JLabel lbNhanVien = new JLabel("NHÂN VIÊN", JLabel.CENTER);
        ...
        ImageIcon iconTaiKhoan = new ImageIcon("./src/Images/user.png");
        ...
        JLabel lbTaiKhoan = new JLabel("TÀI KHOẢN", JLabel.CENTER);
